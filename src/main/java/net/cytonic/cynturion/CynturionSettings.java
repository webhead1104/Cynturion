...
public class CynturionSettings {
    ...
    public static void importFromProperties() {
        ...
        if (System.getProperty("DATABASE_PORT")!= null) DATABASE_PORT = Integer.parseInt(System.getProperty("DATABASE_PORT"));
        ...
        if (System.getProperty("DATABASE_PASSWORD")!= null) DATABASE_PASSWORD = System.getProperty("DATABASE_PASSWORD");
        if (System.getProperty("DATABASE_USE_SSL")!= null) DATABASE_USE_SSL = Boolean.parseBoolean(System.getProperty("DATABASE_USE_SSL"));
    }
    ...
    public static void importFromEnv() {
        ...
        if (System.getenv("DATABASE_USE_SSL")!= null) DATABASE_USE_SSL = Boolean.parseBoolean(System.getenv("DATABASE_USE_SSL"));
    }
